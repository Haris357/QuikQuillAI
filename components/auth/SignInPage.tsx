  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <Card className="shadow-upwork-hover border-0">
          ...
          <CardContent className="space-y-6">
            ...
            <Button
              onClick={onSignIn}
              disabled={loading}
              className="w-full bg-white border-2 border-gray-200 text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all duration-200"
              size="lg"
            >
        ...
        <div className="mt-8 grid grid-cols-1 gap-4">
          <div className="flex items-center space-x-3 text-sm text-gray-600">
            ...
            <span>Create unlimited AI writer agents</span>
          </div>
          <div className="flex items-center space-x-3 text-sm text-gray-600">
            <CheckCircle className="h-4 w-4 text-green-500 flex-shrink-0" />
            <span>Real-time collaboration and editing</span>
          </div>
          <div className="flex items-center space-x-3 text-sm text-gray-600">
            <CheckCircle className="h-4 w-4 text-green-500 flex-shrink-0" />
            <span>Advanced revision history and branching</span>
          </div>
        </div>
      </motion.div>
    </div>
